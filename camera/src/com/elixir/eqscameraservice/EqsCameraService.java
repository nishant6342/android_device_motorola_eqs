...
public class EqsCameraService extends Service {

    private static final boolean DEBUG = false;
    private static final String TAG = "EqsCameraService";
    ...
    public static void startService(Context context) {
        ...
        context.startServiceAsUser(new Intent(context, EqsCameraService.class),
                UserHandle.CURRENT);
    }
