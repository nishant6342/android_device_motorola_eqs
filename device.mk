...
PRODUCT_COPY_FILES += \
    ...
    $(LOCAL_PATH)/audio/sku_cape/audio_policy_configuration.xml:$(TARGET_COPY_OUT_VENDOR)/etc/audio/sku_cape_qssi/audio_policy_configuration.xml \
...
# Thermal
PRODUCT_COPY_FILES += \
    $(LOCAL_PATH)/configs/thermal-engine-eqs-perf.conf:$(TARGET_COPY_OUT_VENDOR)/etc/thermal-engine-eqs.conf
